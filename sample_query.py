...
path = "D:\\GitHome\\"
census_data_path = path+"/privbayes/resources/fakedata_pandas.csv"
synthetic_data_path = path + "/privbayes/result/FakeSyntheticData.csv"
...
print "Census case: " + str(query0(census_df).shape)
print "Synthetic case: " + str(query0(synthetic_df).shape)
