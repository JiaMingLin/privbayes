...
public class Fakedata {
	...
	public static void main(String[] args) throws Exception {
		...
		Domain domain = new Domain(RESOURCE_PATH + "fakedata2.domain.csv");
		Data gTrain = new Data(RESOURCE_PATH + "fakedata2.csv", domain);
		//
//		gTrain.printo_int("result/fakedata-coarse.csv", ",");
		...
		bayes.release().generalization()
				.printo_int("result/Fake2SyntheticDataTrans.csv", ",");
		bayes.release().generalization()
				.printo_data("result/Fake2SyntheticData.csv", ",");
